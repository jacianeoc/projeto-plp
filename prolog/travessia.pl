...
visualizaMargens(Margem1):-writeln('').

desfazerJogada(Margem1,Margem2, _, _, Margem1Final,Margem2Final):-
...
desfazerJogada(_,_, JogadaMargem1, JogadaMargem2, Margem1Final,Margem2Final):-
        writeln('Desfazer Jogada? [s/n] '),
        read(Op),
        Op \= 's',
...
iniciar((0,0,0,0), (1,2,3,4)):- writeln('                                       Ｇａｎｈｏｕ！ Ｐａｒａｂｅｎｓ ！        ').
...
solucao('s'):- writeln('                             S O L U Ç Ã O '),
               nl,
               ...
               writeln('Passo 7- O barqueiro leva a raposa, fim !!!!!').
solucao(_).

iniciar(Margem1, Margem2):-visualizaMargens(Margem1),
